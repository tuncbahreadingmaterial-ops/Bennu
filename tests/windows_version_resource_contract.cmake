...
file(READ "${BENNU_SOURCE_DIR}/tests/windows_version_resource.ps1" native_text)
...
require_text(native_text "mt.exe" "target-native PE manifest extraction")
require_text(native_text "longPathAware" "target-native long-path policy inspection")
