...
int main(void) {
  ...
  _Static_assert(BENNU_PRIMITIVE_DEC == 14, "primitive id mismatch");
  _Static_assert(BENNU_PRIMITIVE_NEG == 15, "primitive id mismatch");
  _Static_assert(BENNU_PRIMITIVE_ABS == 16, "primitive id mismatch");
  _Static_assert(BENNU_PRIMITIVE_SUB == 17, "primitive id mismatch");
  _Static_assert(BENNU_PRIMITIVE_MUL == 18, "primitive id mismatch");
...
int main(int argument_count, char **arguments) {
  ...
  if (!emit_and_build(profile_source, exact_profile, arguments[4], arguments[5],
      ...
      !emit_parameter_probe_and_build(
          "parameters[n Int]\niota[n]\n", parameter_profile,
          arguments[34], arguments[35], arguments[1],
          parameter_profile_assertions, "2") ||
      !emit_parameter_probe_and_build(
          "parameters[n Int]\niota[n]\n", parameter_allocation,
          arguments[36], arguments[37], arguments[1],
  ...
  const bennu::NativeBuildResult standard_fenv_probe_native =
      bennu::build_native(bennu::NativeBuildRequest{
          *standard_fenv_probe, arguments[38], arguments[1], ""});
